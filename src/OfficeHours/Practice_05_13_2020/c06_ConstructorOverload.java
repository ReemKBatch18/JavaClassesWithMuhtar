...
public class c06_ConstructorOverload {
    ...
    public c06_ConstructorOverload(){
        ...
        // if we delete this constructor ==> compiler will not create it again because we already have antoher constructor
    ...
    public static void main(String[] args) {
        c06_ConstructorOverload obj = new c06_ConstructorOverload(10); // 2nd constructor
        c06_ConstructorOverload obj2 = new c06_ConstructorOverload(10,1.5); // 3rd constructor
